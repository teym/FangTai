...
function playFilter(info){
    ...
    function start(val){
        ...
        context.beginPath();
        context.moveTo(0,blank+info.height*0.05);
        context.bezierCurveTo(info.width*0.25,blank+info.height*0.15,info.width*0.75,blank+(-info.height*0.05),info.width,blank+info.height*0.05);
        ...
        context.beginPath();
        context.moveTo(0,blank+info.height*0.08);
        context.bezierCurveTo(info.width*0.25,blank+info.height*0.18,info.width*0.75,blank+(-info.height*0.02),info.width,blank+info.height*0.08);
        context.lineTo(info.width,info.height);
        context.lineTo(0,info.height);
        context.closePath();
        /* 增加渐变色 */
